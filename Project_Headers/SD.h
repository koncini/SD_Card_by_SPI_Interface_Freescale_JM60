...
#define SD_PRESENTb      PTFD_PTFD7
#define SD_PRESENTbPE    PTFPE_PTFPE7
#define _SD_PRESENTb     PTFDD_PTFDD7
#define SD_PRESENTa      PTAD_PTAD4
#define _SD_PRESENTa     PTADD_PTADD4
